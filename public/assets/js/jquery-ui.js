...
(function(factory) {
    ...
    function Datepicker() {
        ...
        this.regional = [""];
        this.regional["id"] = {
            closeText: "oke", // Display text for close link
            ...
            dayNames: ["Minggu", "Senin", "Selasa", "Wednesday", "Thursday", "Friday", "Saturday"], // For formatting
        ...
        this.regional.id = $.extend(true, {}, this.regional["id"]);
        this.regional["id"] = $.extend(true, {}, this.regional.id);
