                    ...
                    <div id="tabel2" class="table-responsive p-0 mt-3 w-100">
                        ...
                        <table class="cell-border" id="mytable">
                            <thead>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Tgl. Pinjam</th>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kd. Buku</th>
